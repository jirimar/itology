...
<meta charset="utf-8">
<title>ITology s.r.o. | PRIVATE SECTION</title>
...
<meta property="og:site_name" content="ITology s.r.o." />
<meta property="og:title" content="PRIVATE SECTION | ITology s.r.o." />
<meta property="og:type" content="website" />
<meta property="og:url" content="http://localhost:1313/private.php" />
<meta name="twitter:card" content="summary_large_image">
<meta property="twitter:title" content="PRIVATE SECTION">



<meta property="og:image" content="https://raw.githubusercontent.com/opera7133/tella/master/images/tn.png">

<meta name="description" content="Tag vlozeny primo v MD" />
<meta property="og:description" content="Tag vlozeny primo v MD" />
<meta property="twitter:description" content="Tag vlozeny primo v MD" />
  ...
  <main class="flex-grow"><header>
    ...
    <nav class="flex items-center justify-between flex-wrap bg-opacity-100 p-8">
        <div class="flex items-center flex-shrink-0 text-xl text-grey-900 mr-6">
            <a href="http://localhost:1313/"><img alt="ITology Logo"
        ...
        <div class="hidden w-full block flex-grow lg:flex lg:items-center lg:w-auto" id="mobileMenu">
            ...
            <div class="text-lg">
                ...
                <a href="/private/"
                    ...
                    <a href="/cs/" class="duration-200 block mt-4 lg:inline-block lg:mt-0 text-black hover:opacity-60 mr-8">
                      <img alt="Czech language website"
                              class="h-5 mr-3" src="/img/icons/cz.svg">
                    </a>
...
<div class="mx-auto my-10 max-w-6xl">
  <div class="mx-3 col-span-3 lg:col-span-2 px-2">
    <h1 class="title text-5xl mb-4">PRIVATE SECTION</h1>
    <div class="content prose md:prose-lg lg:prose-xl max-w-none py-1"><p><strong>Tag vlozeny primo v MD</strong></p>
  ...
  <div class="copy pl-8 py-5 bg-tlgray-700 text-white text-md">
    &copy; ITology s.r.o. 2025 All Rights Reserved.
  </div>
</footer>
</body>
